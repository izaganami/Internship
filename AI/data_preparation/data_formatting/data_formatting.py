# coding: utf-8
"""
DEPENDENCIES : ffmpeg, open-cv, moviepy, matplotlib, pytest-shutil
"""
...
def decoupe_multiple_vid():
    ...
    for file in onlyfiles:
        print(file)
        decoupe_multiple(jsonPath + file)
...
if __name__ == "__main__":
    ...
    ap.add_argument("-o", "--output", required=False, help="relative path to our output folder, if NONE, default is current workplace folder. No special character, no whitespace nor quotes")
